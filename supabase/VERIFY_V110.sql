select
 ...
 to_regprocedure('public.get_survey_v110(uuid,uuid)') is not null as get_survey_rpc,
 to_regprocedure('public.upsert_survey_v110(uuid,uuid,text,text,text,text,text)') is not null as save_survey_rpc,
